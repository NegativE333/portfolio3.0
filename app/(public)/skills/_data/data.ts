export const data = [
    {
        name: 'Next.js',
        imageUrl: '/nextjs.svg',
        info: 'Next.js is a React framework that simplifies web development by offering server-side rendering, automatic code splitting, and an intuitive project structure. It enhances performance and SEO, supports TypeScript, and facilitates seamless deployment. Next.js is widely used for building modern, scalable web applications with efficient developer workflows.',
    },
    {
        name: 'React.js',
        imageUrl: '/react.svg',
    ...
    },
    {
        name: 'HTML',
        imageUrl: '/html.svg',
        info: 'HTML (Hypertext Markup Language) is the standard markup language used to create the structure and content of web pages. It consists of a series of elements represented by tags, which define the different parts of a webpage, such as headings, paragraphs, images, links, and more. HTML is crucial for building the basic structure of websites and is often used alongside CSS and JavaScript for web development.',
    },
    {
        name: 'Tailwind CSS',
    ...
    },
    {
        name: 'C',
        imageUrl: '/c.svg',
        info: "C is a general-purpose programming language known for its efficiency and low-level access to memory. Developed in the early 1970s, it has influenced many other languages and remains widely used in system programming, embedded systems, and game development. C is valued for its performance, portability, and the control it offers to programmers."
    },
    {
        name: 'Vercel',
