...
const BlogPage = async ({
  ...
  const data: fullBlog = await getData(params.slug);
    ...
    return (  
      ...
      <div className="sm:hidden bg-gray-500/30 p-4 rounded-lg w-[95%]">
      <div className={cn("sm:mt-2 mb-8 prose prose-blue prose-lg dark:prose-invert prose-li:marker:text-blue-400 prose-a:text-primary text-justify", rFont.className)}>
          <PortableText value={data.content} components={RichText}/>
        </div>
      </div>
    </div>
